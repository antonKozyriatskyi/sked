...
import kozyriatskyi.anton.sked.util.zipFlows

class WeekViewInteractor(private val scheduleStorage: ScheduleStorage,
                         private val userInfoStorage: UserInfoStorage) {

    fun lessons(weekNumber: Int): Flow<List<Day>> {
        ...
        fun observeDay(dayNumber: Int, date: String): Flow<Day> =
        ...
        ) { d1, d2, d3, d4, d5, d6, d7 -> listOf(d1, d2, d3, d4, d5, d6, d7) }
    }
