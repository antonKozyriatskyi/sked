package kozyriatskyi.anton.sked.ui.activity
...
import kozyriatskyi.anton.sked.presentation.presenter.LoginPresenter
...
import kozyriatskyi.anton.sked.util.OnInternetConnectionChangeListener
import kozyriatskyi.anton.sked.util.OnLoadingStateChangeListener
...
class LoginActivity : MvpAppCompatActivity(), LoginView, OnInternetConnectionChangeListener,
    ...
    companion object {
        ...
        fun start(context: Context, userType: LoginActivity.UserType) {
            val intent = Intent(context, LoginActivity::class.java)
            intent.putExtra(LoginActivity.Companion.EXTRA_MODE, userType)
    ...
    private lateinit var onLoadButtonClickListener: LoginActivity.OnLoadButtonClickListener
    ...
    fun providePresenter(): LoginPresenter {
        val userType = intent.getSerializableExtra(LoginActivity.Companion.EXTRA_MODE) ?: throw NullPointerException("userType must not be null")
        //TODO use dagger to provide dependency
        return LoginPresenter(userType as LoginActivity.UserType, ResourceManager(this))
    }
...
//        supportActionBar?.title = toolbarTitle
    ...
    override fun onAttachFragment(fragment: Fragment) {
        ...
        if (fragment is LoginActivity.OnLoadButtonClickListener) {
